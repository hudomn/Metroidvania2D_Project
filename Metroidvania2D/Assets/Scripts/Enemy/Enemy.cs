...
public class Enemy : Entity
{
    ...
    public virtual void FreezeTimeFor(float _duration) => StartCoroutine(FreezeTimerCoroutime(_duration));
    

    protected virtual IEnumerator FreezeTimerCoroutime(float _seconds)
    {
        FreezeTime(true);
